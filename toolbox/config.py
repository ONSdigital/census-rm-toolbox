...
class Config:
    ...
    BULK_QID_LINK_FILE_PREFIX = os.getenv('BULK_NON_COMPLIANCE_FILE_PREFIX', 'link_qid_')
    BULK_QID_LINK_BUCKET_NAME = os.getenv('BULK_NON_COMPLIANCE_BUCKET_NAME')
    BULK_QID_LINK_PROJECT_ID = os.getenv('BULK_NON_COMPLIANCE_PROJECT_ID')
    BULK_QID_LINK_ROUTING_KEY = os.getenv('BULK_NON_COMPLIANCE_ROUTING_KEY', 'event.questionnaire.update')
