...
class Config:
    ...
    BULK_INVALID_ADDRESS_RECIPIENT_EMAIL = os.getenv('BULK_INVALID_ADDRESS_RECIPIENT_EMAIL')
    ...
    GOV_NOTIFY_EMAIL_API_KEY = os.getenv('GOV_NOTIFY_EMAIL_API_KEY')
    GOV_NOTIFY_EMAIL_TEMPLATE_ID = os.getenv('GOV_NOTIFY_EMAIL_TEMPLATE_ID')
