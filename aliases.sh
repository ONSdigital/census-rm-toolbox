...
alias queuetool='python message_tools/queue_manipulator.py'
alias findbadqueues='python monitoring/poison_message_queue_finder.py -r'
alias findpubsubmessages='python message_tools/get_pubsub_messages.py'
alias pubsubmessagetobucket='python message_tools/put_message_on_bucket.py'
alias buckettopubsub='python message_tools/publish_message_from_bucket.py'
...
alias dumpfilestoqueue='python message_tools/dump_files_to_queue.py'
alias adventure='python adventure.py'
alias dumpqueuetofiles='python message_tools/dump_queue_to_files.py'
alias listqueues='python monitoring/poison_message_queue_finder.py'
alias makemessage='python message_tools/message_maker.py'
...
alias msgwizard='python message_tools/bad_message_wizard.py'
...
alias fulfilment='python monitoring/fulfilment_count.py'
alias weekendfulfilment='python monitoring/weekend_fulfilment_count.py'
