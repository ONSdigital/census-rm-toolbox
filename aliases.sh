...
alias qidcheck='python python -m toolbox.qid_checksum_validator --modulus $QID_MODULUS --factor $QID_FACTOR'
alias qidlink='python python -m toolbox.questionnaire_linking'
