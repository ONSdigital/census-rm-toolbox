...
alias findbadqueues='python -m toolbox.monitoring.poison_message_queue_finder -r'
...
alias listqueues='python -m toolbox.monitoring.poison_message_queue_finder'
...
alias fulfilment='python -m toolbox.monitoring.fulfilment_count'
alias weekendfulfilment='python -m toolbox.monitoring.weekend_fulfilment_count'
